 ...
 * meteo.php
 *
 * Page de sélection des prévisions météo par région, département et ville en France.
 * Affiche une carte interactive des régions françaises et un formulaire de sélection
 * pour choisir une région, un département et une ville. Inclut une bannière de
 ...
 * @license    MIT License
 * @version    1.0.0
 * @link       http://localhost:8000/meteo.php
 * @since      2025
 *
 * @global string $pageTitle Titre de la page affiché dans la balise <title>.
 *
 * @requires include/functions.inc.php Fournit les fonctions utilitaires (ex. shouldShowCookieConsent()).
 ...
 * @requires css/meteo.css Feuille de style spécifique pour la mise en page.
 * @requires js/meteo.js Script JavaScript pour gérer la carte et le formulaire.
 * @requires js/cookie-consent.js Script JavaScript pour gérer la bannière de consentement.
 * @requires img/CarteDeFrance.jpeg Image de la carte des régions françaises.
 *
 * @see regions.php Page cible pour afficher les prévisions météo d'une région.
 */

    ...
    <div class="weather-cards-container">
        ...
        <div class="weather-card-small">
            <div class="weather-icon">
                <img src="<?= getWeatherIcon($meteo['description']) ?>" alt="Icone météo">
            </div>
            <div class="weather-info">
                <h3>Actuellement</h3>
                <p class="temperature"><?= $meteo['temperature'] ?> °C</p>
                <p class="description"><?= htmlspecialchars($meteo['description']) ?></p>
            </div>
        </div>
        ...
        <div class="weather-card-small">
            <div class="weather-icon">
                <img src="<?= getWeatherIcon($meteo['demain']) ?>" alt="Icone météo">
            </div>
            <div class="weather-info">
                <h3>Demain</h3>
                <p class="description"><?= htmlspecialchars($meteo['demain']) ?></p>
            </div>
        </div>
    </div>
        ...
        <?php foreach ($meteo['semaine'] as $jour): ?>
            ...
            <div class="daily-forecast-card">
                ...
                <div class="forecast-icon">
                    <img src="<?= getWeatherIcon($condition) ?>" alt="<?= htmlspecialchars($condition) ?>">
                </div>
                <div class="forecast-temps">
                    <span class="temp-max"><?= $max ?>°C</span>
                    <span class="temp-min"><?= $min ?>°C</span>
                </div>
                <div class="forecast-desc"><?= htmlspecialchars($condition) ?></div>
            </div>
            <?php } ?>
        <?php endforeach; ?>
    </div>
